function [keyRate, modParser, debugInfo] = FiniteLossyQubitBB84KeyRateFunc(params,options,mathSolverFunc,debugInfo)
...
%   measurments. These are organized in a 4x5 table. The
...
%Retrieve t values
params.t = 10.^(params.tExp)*ones(size(params.observablesJoint));
...
%% compute mu
[muLower,muUpper] = mubetaUpperLower(params.N, params.ptest*params.expectationsJoint, params.t, log10(params.epsilon.PE));  
