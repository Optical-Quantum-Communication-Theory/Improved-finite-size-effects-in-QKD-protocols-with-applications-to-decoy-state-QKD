function [newParams,modParser] = FourSixWCPDifInt_AdaptiveDescription(params, options, debugInfo)
...
%% generate rhoA
probSignalsAgen = [3/8, 3/8, 1/8, 1/8]; %p(a|gen)
...
% newParams.keyMap = [ KeyMapElement("Z", "Z", [1, 2]) ]; %% X basis used for testing 
...
%n_sift = floor(newParams.n*pxB); %%needs to be changed
